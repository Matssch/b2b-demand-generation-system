...
A strong demand generation engine therefore starts by understanding the market before deciding which channels, accounts or campaigns deserve investment. The basic logic is:

**Market → Opportunity → ICP → Segment → Campaign → Pipeline**
...
- Which geographies are relevant?
- What company sizes fit the product?
- Which use cases create the strongest value?
...
- the problem is weak,
- there is no budget,
- the buying process is extremely complex,
- or the product has little differentiation,

then the segment may not deserve significant marketing investment.
...
| Factor | Question |
|---|---|
| Need | How strongly does this segment experience the problem? |
| Value | How much value can the solution create? |
| Budget | Is there realistic ability and willingness to pay? |
| Reachability | Can Marketing and Sales efficiently reach the buyer? |
| Competition | How difficult is the market to win? |
| Sales complexity | How long and complex is the buying journey? |
| Strategic fit | Does this segment fit the company’s growth direction? |
| Expansion | Can the relationship grow after acquisition? |

This helps prevent Marketing from chasing large but commercially weak audiences.
...
|---|---|---|---|
| Smaller accounts | Self-service | High | Low |
| Mid-market | Hybrid | High | Medium |
| Larger accounts | Sales-led | Supporting + account-focused | High |

The exact segment boundaries depend on the business.
...
A smaller customer may require:

- Lower CAC
- Strong self-service conversion
...
| Market opportunity | Need | Value | Reach | Ability to win | Priority |
|---|---:|---:|---:|---:|---:|
| Segment A | 5 | 5 | 4 | 4 | High |
| Segment B | 4 | 3 | 5 | 4 | Medium/High |
...
2. **Which problems are commercially important?**
3. **Which segments deserve priority?**
4. **What buying motion fits each segment?**
5. **What level of pipeline could the opportunity support?**

Only then should we define the ideal customer more precisely.
