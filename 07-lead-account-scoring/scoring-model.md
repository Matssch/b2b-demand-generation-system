...
- Whether Sales should act now

The scoring model therefore combines:
...
The stronger unit for larger B2B opportunities is usually the account.
...
|---|---:|
| Strong ICP company size | +15 |
| Priority industry | +15 |
| Priority geography | +10 |
| Strong use-case fit | +20 |
| High customer-value potential | +15 |
...
| Signal | Example points |
|---|---:|
| Outside target geography | -30 |
| Too small for viable economics | -20 |
| Weak use case | -20 |
| No realistic budget | -20 |
...
| Case-study engagement | +10 |
| Repeat solution-page visits | +10 |
| High-intent search visit | +15 |
| Event attendance | +10 |

Intent signals should receive different weight depending on how closely they relate to a buying decision.
...
|---|---:|
| First content visit | +2 |
| Second website session | +5 |
| Email click | +5 |
...
|---|---:|
| Problem owner engaged | +10 |
| Champion identified | +15 |
| Decision-maker engaged | +20 |
| Economic buyer engaged | +20 |
| Technical stakeholder engaged | +10 |
...
This helps prevent Marketing from optimising only for easiest conversion.
...
This is why raw engagement should not drive prioritisation alone.
...
The thresholds should be validated against actual opportunity data.
...
- 8–30 days → 75%
- 31–60 days → 50%
- 60+ days → lower weight

This helps the model reflect current momentum.
...
If a signal does not help predict commercial quality, reduce or remove it.
...
- Was timing wrong?
- Was the opportunity commercially viable?
...
This gives Sales context instead of another anonymous MQL.
